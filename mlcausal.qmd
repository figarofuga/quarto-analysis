...
simple_fit <- glm(bin_outcome ~ age + sex + bmi + hf + bnp + lvef + ca, family = binomial, data = toy_data)

rcs_fit <- glm(bin_outcome ~ rcs(age, 4) + sex + rcs(bmi, 4) + hf + rcs(bnp, 4) + rcs(lvef, 4) + ca, family = binomial, data = toy_data)
