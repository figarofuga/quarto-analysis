...
# SES: integer 1-5, expected value 3
# Binomial(4, 0.5) gives 0-4 with mean 2; add 1 gives 1-5 with mean 3
ses <- rbinom(n, size = 4, prob = 0.5) + 1
...
# ------------------------------------------------------------
# 2. Comorbidities
#    Age, Sex, SES -> HF, HTN, Stroke, Frail
# ------------------------------------------------------------
...
htn <- rbinom(n, size = 1, prob = p_htn)
...
stroke <- rbinom(n, size = 1, prob = p_stroke)
...
frail <- rbinom(n, size = 1, prob = p_frail)
